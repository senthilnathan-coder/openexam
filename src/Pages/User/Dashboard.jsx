...
const UserDashboard = () => {
  const [dashboardData, setDashboardData] = useState({
    streakData: { current: 7, longest: 15 },
    progressData: [
    ...
    leaderboard: { rank: 12, totalUsers: 1000 },
    points: { current: 2500, monthly: 450 },
    planUsage: { used: 75, total: 100 },
    savedQuizzes: [
      { id: 1, title: 'Math Quiz 1', score: 85 },
      { id: 2, title: 'Science Quiz 2', score: 92 }
    ],
    attemptHistory: [
      { date: '2024-04-01', quiz: 'Math Quiz', score: 85 },
      { date: '2024-04-02', quiz: 'Science Quiz', score: 92 }
    ],
    referrals: { count: 5, earnings: 250 }
  });
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-r from-slate-900 to-purple-900 p-6 mt-20"
